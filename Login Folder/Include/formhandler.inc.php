...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    try{
        ...
        $query = "INSERT INTO userGenres (username) 
        ...
        $userGenres = ['Pop', 'Rock', 'Jazz', 'Hip-Hop', 'Indie',
         'EDM', 'Country', 'Classical', 'R&B', 'Metal'];

        foreach($userGenres as $genres){
            $query = "INSERT INTO userGenres (username, genre, checked) 
        
            VALUES (:uname, :genre, 0);";
