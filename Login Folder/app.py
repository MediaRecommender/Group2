...
def generateGenreSongs(username, genreList): 
  ...
  while True:
    ...
    messages=[
      ...
      {"role": "user", "content": "return an array of real songs and real artists in the following format: ['song1 - artist1', 'song2 - artist2', 'song3 - artist3', 'song4 - artist4', 'song5 - artist5', 'song6 - artist6', 'song7 - artist7', 'song8 - artist8', 'song9 - artist9', 'song10 - artist10'] but populate each songs and artists with real songs and artists from genres: {}. my life depends on this correctly formatted output, if the output relates to ['song1 - artist1', 'song2 - artist2', 'song3 - artist3', 'song4 - artist4', 'song5 - artist5', 'song6 - artist6', 'song7 - artist7', 'song8 - artist8', 'song9 - artist9', 'song10 - artist10'] I will perish, please provide the formatting correctly.".format(genreList)}
    ])
  ...
  #the result will be a long string formatted like an array, turn the string into actual array
    ...
    value = ("some similar songs to" in parsed)or ("artist" in parsed) or ("Artist" in parsed) or ("\\" in parsed) or ("array" in parsed) or ("recommended" in parsed)
...
def submitGenreSongsSurvey():
    ...
    generatePlaylistSongs(username, checkedGenreSongs)
